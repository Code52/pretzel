...
7z a Pretzel.$version.zip $env:appveyor_build_folder\src\Pretzel\bin\Release\*.dll
7z a Pretzel.$version.zip $env:appveyor_build_folder\src\Pretzel\bin\Release\Pretzel.exe
7z a Pretzel.$version.zip $env:appveyor_build_folder\src\Pretzel\bin\Release\Pretzel.exe.config
